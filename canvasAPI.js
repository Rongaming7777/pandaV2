...
const RonCanvasApi = require("./handlers/CanvasApi");
const apiSettings = {
  "valid": [
    "734513783338434591"
  ],
...
app.post("/levelUpCard", async (request, response) => {
    ...
    try {
      ...
      const responseBuffer = await RonCanvasApi.levelUpCard(request.body);
...
app.post("/rankCard", async (request, response) => {
    ...
    try {
      ...
      const responseBuffer = await RonCanvasApi.rankCard(request.body);
...
app.post("/leaderBoardCard", async (request, response) => {
  ...
  try {
    ...
    const responseBuffer = await RonCanvasApi.leaderBoardCard(request.body);
...
app.post("/welcomeDm", async (request, response) => {
  ...
  try {
    ...
    const responseBuffer = await RonCanvasApi.welcomeDm(request.body);
...
app.post("/welcomeChannel", async (request, response) => {
  ...
  try {
    ...
    const responseBuffer = await RonCanvasApi.welcomeChannel(request.body);
