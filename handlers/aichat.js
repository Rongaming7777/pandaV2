    ...
    async function AICHAT(client, message, guild_settings, setups) {
        try{
            ...
            if(message.channel.id == chatbot){
              ...
              {
                  const attachment = new MessageAttachment("https://media.discordapp.net/attachments/873381531769528353/935124088194748466/PicsArt_12-29-07.52.19.jpg")
              ...
              try{
                ...
                message.channel.send({content: "<a:no:921989165242003476> AI CHAT API IS DOWN"}).catch(() => null)
              }
            }
