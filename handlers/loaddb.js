                    ...
                    member.send({
                        embeds: [
                            new MessageEmbed()
                                .setColor(ee.color)
                                .setThumbnail(member.guild.iconURL({ dynamic: true }))
                                .setAuthor(client.getAuthor(`Giveaway Entry Confirmed`, `https://cdn.discordapp.com/emojis/921988805442043925.gif?size=128`))
                    ...
                    member.send({
                        embeds: [
                            new MessageEmbed()
                                .setColor(ee.wrongcolor)
                                .setThumbnail(member.guild.iconURL({ dynamic: true }))
                                .setAuthor(client.getAuthor(`Giveaway Left!`, `https://cdn.discordapp.com/emojis/921988805442043925.gif?size=128`))
                    ...
                    winner.send({
                        ...
                        embeds: [
                            new MessageEmbed()
                                ...
                                .setAuthor(client.getAuthor(`Giveaway Won!`, `https://cdn.discordapp.com/emojis/921988805442043925.gif?size=128`))
