...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls, GuildSettings) => {
    let theemoji = "📜";
    let RonGuild = client.guilds.cache.get("921624360480026654");
    if (RonGuild) theemoji = "945221180338618388";
    ...
    async function first_layer() {
      try {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Application Setup', 'https://cdn.discordapp.com/emojis/877653386747605032.png?size=96', 'https://discord.gg/zG8yUPhuxw'))
    ...
    async function second_layer(SetupNumber, menuoptiondata) {
      try {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor(SetupNumber + " Apply Setup", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/incoming-envelope_1f4e8.png", "https://discord.gg/zG8yUPhuxw"))
        ...
        switch (args) {
                                ...
                                msg.channel.awaitMessages({
                                  ...
                                  if (collected.first().content.toLowerCase() === "no") {
                                    ...
                                    if (!message.guild.me.roles) return message.reply({
                                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable25"])).setAuthor(client.getAuthor("<a:no:921989165242003476> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                                        dynamic: true
                                      })))]
                                    })
            ...
            async function setup_without_channel_creation() {
              ...
              await pickmsg.channel.awaitMessages({filter: (m) => m.author.id === cmduser.id,
                  ...
                  if (channel) {
                    ...
                    throw "<a:no:921989165242003476> ERROR";
                  }
                })
                .catch(e => {
                  errored = e
                    ...
                    message.reply({
                      ...
                      msg.channel.awaitMessages({
                        ...
                        if (collected.first().content.toLowerCase() === "no") {
                          ...
                          if (!message.guild.me.roles) return message.reply({
                            embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable58"])).setAuthor(client.getAuthor("<a:no:921989165242003476> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                              dynamic: true
                            })))]
                          })
          ...
          case "acceptrole": {
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable70"])).setAuthor(client.getAuthor("<a:no:921989165242003476> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  })))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable71"])).setAuthor(client.getAuthor("<a:no:921989165242003476> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                }
            ...
            case "setrole": {
              message.reply({
                ...
                msg.channel.awaitMessages({
                  ...
                  if (!message.guild.me.roles) return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable81"])).setAuthor(client.getAuthor("<a:no:921989165242003476> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                  ...
                  if (guildrole.rawPosition <= botrole.rawPosition) {
                    ...
                    return message.reply({
                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable82"])).setAuthor(client.getAuthor("<a:no:921989165242003476> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                        dynamic: true
                      })))]
                    })
                  }
            ...
            case "setrole": {
              message.reply({
                ...
                msg.channel.awaitMessages({
                  ...
                  if (!message.guild.me.roles) return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable100"])).setAuthor(client.getAuthor("<a:no:921989165242003476> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                  ...
                  if (guildrole.rawPosition <= botrole.rawPosition) {
                    ...
                    return message.reply({
                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable101"])).setAuthor(client.getAuthor("<a:no:921989165242003476> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                        dynamic: true
                      })))]
                    })
                  }
            ...
            case "setrole": {
              message.reply({
                ...
                msg.channel.awaitMessages({
                  ...
                  if (!message.guild.me.roles) return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable119"])).setAuthor(client.getAuthor("<a:no:921989165242003476> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                  ...
                  if (guildrole.rawPosition <= botrole.rawPosition) {
                    ...
                    return message.reply({
                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable120"])).setAuthor(client.getAuthor("<a:no:921989165242003476> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                        dynamic: true
                      })))]
                    })
                  }
            ...
            case "setrole": {
              message.reply({
                ...
                msg.channel.awaitMessages({
                  ...
                  if (!message.guild.me.roles) return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable140"])).setAuthor(client.getAuthor("<a:no:921989165242003476> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                  ...
                  if (guildrole.rawPosition <= botrole.rawPosition) {
                    ...
                    return message.reply({
                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable141"])).setAuthor(client.getAuthor("<a:no:921989165242003476> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                        dynamic: true
                      })))]
                    })
                  }
            ...
            case "setrole": {
              message.reply({
                ...
                msg.channel.awaitMessages({
                  ...
                  if (!message.guild.me.roles) return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable161"])).setAuthor(client.getAuthor("<a:no:921989165242003476> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                  ...
                  if (guildrole.rawPosition <= botrole.rawPosition) {
                    ...
                    return message.reply({
                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable162"])).setAuthor(client.getAuthor("<a:no:921989165242003476> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                        dynamic: true
                      })))]
                    })
                  }
          ...
          case "editquestion": {
            ...
            var embed = new Discord.MessageEmbed()
              ...
              .setColor(es.color)
              .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable174"])) //RôÑ#6426
                  ...
                  message.reply({
                    ...
                    msg.channel.awaitMessages({
                      ...
                      var new_embed = new Discord.MessageEmbed().setFooter(client.getFooter(es))
                        .setColor(es.color)
                        .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable177"])) //RôÑ#6426
          ...
          case "temprole":
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable183"])).setAuthor(client.getAuthor("<a:no:921989165242003476> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  })))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable184"])).setAuthor(client.getAuthor("<a:no:921989165242003476> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                }
          ...
          case "addquestion": {
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                var embed = new Discord.MessageEmbed().setFooter(client.getFooter(es))
                  .setColor(es.color)
                  .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable188"])) //RôÑ#6426
                  .setFooter(client.getFooter(message.guild.name, message.guild.iconURL({
                    dynamic: true
                  })))
                  .setTimestamp()
          ...
          case "removequestion": {
            ...
            var embed = new Discord.MessageEmbed()
              ...
              .setColor(es.color)
              .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable190"])) //RôÑ#6426
              .setFooter("ADD THE INDEX TO EDIT THE MSG", message.guild.iconURL({
                dynamic: true
              }))
              .setTimestamp()
            ...
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                if (arr.length >= Number(quindex)) {
                  ...
                  var new_embed = new Discord.MessageEmbed().setFooter(client.getFooter(es))
                    .setColor(es.color)
                    .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable193"])) //RôÑ#6426
                    .setFooter(client.getFooter(message.guild.name, message.guild.iconURL({
                      dynamic: true
                    })))
                    .setTimestamp()
          ...
          var embed = new Discord.MessageEmbed()
            .setFooter(client.getFooter(es))
            .setColor(es.color)
            .setTitle(`${!oldState ? "Enabled Last Verification": "Disabled Last Verification"}`) //RôÑ#6426
            .setDescription(`${!oldState ? "I will now ask the User a last Time if he really wanna apply for the Server": "I will not ask the User"}`) //RôÑ#6426
            .setTimestamp()
          message.reply({
            embeds: [embed]
          });
