...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls, GuildSettings) => {
    ;
    //only allow the Server owner, (&Ron) to execute this Command, (Ron just because if he needs to help for Shop Bots)
    ...
    try {
      ...
      async function first_layer(){
        ...
        .setColor(es.color)
        .setAuthor('Anti Nuke Setup', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.gg/zG8yUPhuxw')
        ...
        async function menuselection(menu) {
          ...
          if(menu?.values[0] == "Information"){
            ...
            let MenuEmbed = new Discord.MessageEmbed()
            .setColor(es.color)
            .setAuthor('Anti Nuke Settings', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.gg/zG8yUPhuxw')
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author?.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leave:934404917597179906> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Bot add__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author?.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leave:934404917597179906> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Kick/Ban__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author?.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leave:934404917597179906> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Create Role__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author?.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leave:934404917597179906> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Delete Role__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author?.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leave:934404917597179906> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Channel Create__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author?.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leave:934404917597179906> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Channel Delete__ Whitelist (module)!**`.substring(0, 2048))
              ...
              menuoptions = [
                {
                  ...
                  emoji: await client.Anti_Nuke_System.get(message.guild.id+ ".all.enabled") ? "932825003441946685": "921988805442043925"
                },
                {
                  value: "Set Logger",
                ...
                },
                {
                  ...
                  emoji: await client.Anti_Nuke_System.get(message.guild.id+ ".all.showwhitelistlog") ? "932825003441946685": "921988805442043925"
                },
                {
                ...
                if(String(index) == "0"){
                   ...
                   */
                    ...
                    async function first_layer(){
                      menuoptions = [
                        {
                          ...
                          emoji: await client.Anti_Nuke_System.get(message.guild.id, `${thekey}.enabled`) ? "932825003441946685": "921988805442043925"
                        },
                        {
                      ...
                      let MenuEmbed = new Discord.MessageEmbed()
                        .setColor(es.color)
                        .setAuthor('Antinuke Setup', 'https://media.discordapp.net/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.gg/zG8yUPhuxw')
            ...
            return menu?.reply({content: "<a:yes2:921988805442043925> **Now using the Suggested Settings!**", embeds: [new MessageEmbed()
              .setColor(es.color)
              .setFooter(client.getFooter(es))
              .setTitle(`${await client.Anti_Nuke_System.get(message.guild.id+ ".all.enabled") ? "<a:yes2:921988805442043925> __**The Anti Nuke is enabled!**__": "<a:no:921989165242003476> __**The Anti Nuke is disabled!**__"}`)
              .addField(`__**Anti Add Bot | ${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.enabled") ? "<a:yes2:921988805442043925> Enabled ": "<a:no:921989165242003476> Disabled"}**__`, `>>> [Remove Roles] **Actions / Day: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.removeroles.neededdaycount")}\`**\n[Remove Roles] **Actions / Week: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.removeroles.neededweekcount")}\`\n**[Remove Roles] **Actions / Month: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.removeroles.neededmonthcount")}\`**\n\n[Kick] **Actions / Day: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.kick.neededdaycount")}\`**\n[Kick] **Actions / Week: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.kick.neededweekcount")}\`\n**[Kick] **Actions / Month: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.kick.neededmonthcount")}\`**\n\n[Ban] **Actions / Day: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.ban.neededdaycount")}\`**\n[Ban] **Actions / Week: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.ban.neededweekcount")}\`\n**[Ban] **Actions / Month: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.ban.neededmonthcount")}\`**`)
            ...
            for await (const ch of channels.map(this_Code_is_by_Ron_7777 => this_Code_is_by_Ron_7777)){
              try {
                if(ch) {
