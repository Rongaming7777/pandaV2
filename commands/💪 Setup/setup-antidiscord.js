        ...
        let menuoptions = [
          {
            ...
            emoji: `${GuildSettings?.antidiscord?.enabled ? "932825003441946685" : "921988805442043925"}`
          },
          {
            value: "Settings",
        ...
        switch(menuoptionindex){
          case 0: {
            ...
            return message.reply({embeds: [new Discord.MessageEmbed()
              .setTitle(`<a:yes2:921988805442043925> The Anti Discord Setup is now ${d2p(!previous)}!`)
              .setColor(es.color)
