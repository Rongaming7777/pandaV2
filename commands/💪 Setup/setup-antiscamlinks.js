        ...
        let menuoptions = [
          {
            ...
            emoji: `${GuildSettings?.antidiscordscam?.enabled ? "932825003441946685" : "921988805442043925"}`
          },
          {
            value: "Settings",
          ...
          case 1: {
           let thesettings = await client.settings.get(`${message.guild.id}.antidiscordscam`)
            return message.reply({embeds: [new Discord.MessageEmbed()
              ...
              .setColor(es.color)
              .setDescription(`**Enabled:** ${thesettings.enabled ? "<a:yes2:921988805442043925>" : "<a:no:921989165242003476>"}`.substring(0, 2048))
