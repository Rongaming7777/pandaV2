    ...
    try {
      ...
      switch (Type.toLowerCase()) {
        ...
        case `addcurrenttrack`: {
          ...
          //return susccess message
          return message.reply({embeds : [new MessageEmbed()
            .setTitle(`<a:yes2:921988805442043925> Added ${track.title} onto the Queue \`${Name}\``.substring(0, 256))
        ...
        case `removesong`: {
          ...
          //return susccess message
          return message.reply({embeds :[new MessageEmbed()
            .setTitle(`<a:yes2:921988805442043925> Deleted ${deletetrack.title} of the Queue \`${Name}\``.substring(0, 256))
        ...
        case `mix`: {
          ...
          //return susccess message
          return message.reply({embeds : [new MessageEmbed()
            .setTitle(`<a:yes2:921988805442043925> Shuffled ${newtracks.length} Tracks of the Queue \`${Name}\``.substring(0, 256))
        ...
        case `removeduplicates`: {
          ...
          //return susccess message
          return message.reply({embeds : [new MessageEmbed()
            .setTitle(`<a:yes2:921988805442043925> Removed ${counter} Tracks from the Queue \`${Name}\``.substring(0, 256))
