...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls, GuildSettings) => {
    ...
    try {
      ...
      let approve = new MessageButton().setStyle('SUCCESS').setCustomId('1').setEmoji("921988805442043925").setLabel("YES DO IT!")
      let deny = new MessageButton().setStyle('PRIMARY').setCustomId('2').setEmoji("932825003441946685").setLabel("Cancel")
