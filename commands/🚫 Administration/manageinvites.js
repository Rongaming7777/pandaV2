...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls, GuildSettings) => {
    ...
    try {
      ...
      let menuoptions = [
        {
          ...
          emoji: "934404954741948416" //optional
        },
        {
          value: "Remove Joins",
        ...
        },
        {
          ...
          emoji: "932825003441946685" //optional
        },
        {
          value: "Remove Fakes",
      ...
      .addField("**CURRENT INVITES:**", `<:Like:936492126093578260> ${user} _**has invited __${realinvites} Member${realinvites != 1 ? "s": ""}__**_!`)
      ...
      async function menuselection(menu) {
        ...
        await menu?.reply({embeds : [new MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.gg/zG8yUPhuxw"))
          ...
          await message.channel.awaitMessages({filter: m=>m.author.id == cmduser.id, max: 1, time: 60e3, errors: ["time"]}).then(collected=>{
            ...
            message.reply({embeds : [new MessageEmbed()
              .setAuthor(client.getAuthor(`New Invites of: ${user.tag}`, user.displayAvatarURL({dynamic: true}), "https://discord.gg/zG8yUPhuxw"))
              .setColor(es.color).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
              .addField("\u200b", `<:Like:936492126093578260> ${user} _**has invited __${realinvites} Member${realinvites != 1 ? "s": ""}__**_!`)
