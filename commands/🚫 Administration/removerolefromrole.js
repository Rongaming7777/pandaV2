   ...
   run: async (client, message, args, cmduser, text, prefix, player, es, ls, GuildSettings) => {
     ...
     try {
      ...
      let cmdroles = GuildSettings?.cmdadminroles?.removerolefromrole || [];
       ...
       var members = message.guild.members.cache.filter(member => member.roles.cache.has(rolehas.id) && member.roles.cache.has(role.id)).map(this_Code_is_by_Ron_7777 => this_Code_is_by_Ron_7777);
       ...
       message.reply({embeds:  [new MessageEmbed()
         ...
         .setFooter(client.getFooter(es))
         .setAuthor(client.getAuthor((`Changing roles for ${members.length} Members...`, "https://images-ext-1.discordapp.net/external/ANU162U1fDdmQhim_BcbQ3lf4dLaIQl7p0HcqzD5wJA/https/cdn.discordapp.com/emojis/756773010123522058.gif", "https://discord.gg/zG8yUPhuxw")))
